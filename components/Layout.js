...
export default function Layout({ children, home }) {
    ...
    return (
        <div className="bg-pink-300 text-gray-800 dark:bg-black dark:text-gray-200 h-screen">
            <div className={styles.container}>
                ...
                <button className='w-30 px-2' onClick={handleClick}>
                    {theme === 'dark' ? <CiDark className='w-[32px] h-[32px]' /> : <FaSun className='w-[32px] h-[32px]' />}
                </button>
